...
@section('content')
  ...
  <div class="container">
    ...
    <div class="container-header">
      <div class="row">
        <div class="col-lg-7 col-sm-12">
          ...
          <p>นำบิษัท ร้านค้าหรือธุรกิจของคุณเข้าสู่ชุมชน เพื่อเชื่อมต่อธุรกิจของคุณกับชุมชนและผู้คนในชลบุรี เพื่อสะดวกต่อการค้นหาบิษัท ร้านค้า สินค้า แบรนด์ งานบริการ ตำแหน่งงาน และอื่นๆ อีกมากมาย</p>
        </div>
      </div>
    </div>
    ...
    <?php
      echo Form::submit('เข้าสู่ชุมชน' , array(
        'class' => 'button'
      ));
    ?>
